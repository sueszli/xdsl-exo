...
from xdsl.dialects.builtin import DenseIntOrFPElementsAttr, FloatAttr, TensorType, VectorType, f32, i32
from xdsl.dialects.math import AbsFOp, AbsIOp, Atan2Op, AtanOp, CbrtOp, CeilOp, CopySignOp, CosOp, CountLeadingZerosOp, CountTrailingZerosOp, CtPopOp, ErfOp, Exp2Op, ExpM1Op, ExpOp, FloorOp, FmaOp, FPowIOp, IPowIOp, Log1pOp, Log2Op, Log10Op, LogOp, PowFOp, RoundEvenOp, RoundOp, RsqrtOp, SinOp, SqrtOp, TanhOp, TanOp, TruncOp
...
class Test_float_math_binary_construction:
    ...
    f32_tensor_type = DenseIntOrFPElementsAttr.create_dense_float(TensorType(f32, []), [5.5])
...
class Test_int_math_unary_constructions:
    ...
    i32_tensor_type = DenseIntOrFPElementsAttr.create_dense_int(TensorType(i32, []), [5])
