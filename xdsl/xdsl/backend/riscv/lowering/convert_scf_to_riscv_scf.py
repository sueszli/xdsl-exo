from xdsl.backend.riscv.lowering.utils import cast_block_args_to_regs, cast_matched_op_results, cast_operands_to_regs, move_to_unallocated_regs
...
class ScfForLowering(RewritePattern):
    ...
    def match_and_rewrite(self, op: scf.ForOp, rewriter: PatternRewriter) -> None:
        ...
        mv_res_ops, res_values = move_to_unallocated_regs(new_op.results, op.iter_args.types)
