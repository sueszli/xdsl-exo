...
@proc
def _adam_neon(N: size, param: f32[N] @ DRAM, grad: f32[N] @ DRAM, m: f32[N] @ DRAM, v: f32[N] @ DRAM, b1: f32[1] @ DRAM, b2: f32[1] @ DRAM, eps: f32[1] @ DRAM, lr: f32[1] @ DRAM, beta1_t: f32[1] @ DRAM, beta2_t: f32[1] @ DRAM):
    one: f32[1] @ DRAM
    one[0] = 1.0
    b1_v: f32[4] @ NEON
    b2_v: f32[4] @ NEON
...
@proc
def _adam_neon_par(N: size, param: f32[N] @ DRAM, grad: f32[N] @ DRAM, m: f32[N] @ DRAM, v: f32[N] @ DRAM, b1: f32[1] @ DRAM, b2: f32[1] @ DRAM, eps: f32[1] @ DRAM, lr: f32[1] @ DRAM, beta1_t: f32[1] @ DRAM, beta2_t: f32[1] @ DRAM):
    one: f32[1] @ DRAM
    one[0] = 1.0
    b1_v: f32[4] @ NEON
    b2_v: f32[4] @ NEON
