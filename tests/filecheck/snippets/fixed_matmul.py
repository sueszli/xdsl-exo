...
# CHECK-NEXT:     %15 = arith.index_cast %6 : i64 to index
# CHECK-NEXT:     %pointer_dim_stride_4 = arith.constant 16 : index
# CHECK-NEXT:     %pointer_dim_offset_2 = arith.muli %13, %pointer_dim_stride_4 : index
# CHECK-NEXT:     %pointer_dim_stride_5 = arith.addi %pointer_dim_offset_2, %15 : index
...
# CHECK-NEXT:     %16 = "llvm.load"(%offset_pointer_14) <{ordering = 0 : i64}> : (!llvm.ptr) -> f32
# CHECK-NEXT:     %17 = arith.mulf %14, %16 : f32
# CHECK-NEXT:     %pointer_dim_stride_6 = arith.constant 16 : index
# CHECK-NEXT:     %pointer_dim_offset_3 = arith.muli %12, %pointer_dim_stride_6 : index
# CHECK-NEXT:     %pointer_dim_stride_7 = arith.addi %pointer_dim_offset_3, %15 : index
...
# CHECK-NEXT:     %18 = "llvm.load"(%offset_pointer_18) <{ordering = 0 : i64}> : (!llvm.ptr) -> f32
# CHECK-NEXT:     %19 = arith.addf %18, %17 : f32
# CHECK-NEXT:     %20 = arith.index_cast %4 : i64 to index
# CHECK-NEXT:     %21 = arith.index_cast %6 : i64 to index
# CHECK-NEXT:     %pointer_dim_stride_8 = arith.constant 16 : index
# CHECK-NEXT:     %pointer_dim_offset_4 = arith.muli %20, %pointer_dim_stride_8 : index
# CHECK-NEXT:     %pointer_dim_stride_9 = arith.addi %pointer_dim_offset_4, %21 : index
...
# CHECK-NEXT:     "llvm.store"(%19, %offset_pointer_22) <{ordering = 0 : i64}> : (f32, !llvm.ptr) -> ()
# CHECK-NEXT:     %22 = arith.addi %10, %2 : i64
# CHECK-NEXT:     cf.br ^bb5(%22 : i64)
# CHECK-NEXT:   ^bb7:
# CHECK-NEXT:     %23 = arith.addi %6, %2 : i64
# CHECK-NEXT:     cf.br ^bb1(%23 : i64)
# CHECK-NEXT:   ^bb4:
# CHECK-NEXT:     %24 = arith.addi %4, %2 : i64
# CHECK-NEXT:     cf.br ^bb0(%24 : i64)
# CHECK-NEXT:   ^bb2:
