...
# CHECK-LABEL: llvm.func @reduce_float
...
# CHECK: %[[OP:[0-9]+]] = llvm.getelementptr inbounds %[[OUT]][%[[ZERO]]] : (!llvm.ptr, i64) -> !llvm.ptr, f32
# CHECK: %[[CURRENT:[0-9]+]] = llvm.load %[[OP]] : !llvm.ptr -> f32
# CHECK: %[[SUM:[0-9]+]] = llvm.fadd %[[CURRENT]], %[[V]] {fastmathFlags = #llvm.fastmath<fast>} : f32
# CHECK-NEXT: llvm.store %[[SUM]], %[[OP]] : f32, !llvm.ptr
